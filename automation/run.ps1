...
$problemList = ($items | ForEach-Object { "- $(param()
...
Write-TextNoBom (Join-Path $siteDir "index.html") $indexHtml
...
Write-Host "OK: generated $slug and appended sites.json + created issue notification.".title) ($(param()
...
# final guards
Assert-AllowedChanges
Write-Host "OK: generated $slug and appended sites.json + created issue notification.".url))" }) -join "`n"
